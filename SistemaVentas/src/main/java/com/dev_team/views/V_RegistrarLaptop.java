...
public class V_RegistrarLaptop extends JPanel {
    ...
    private void initComponents() {
        ...
        btn_buscarImange = new javax.swing.JButton();
        ...
        panel_form.add(lb_imagen, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 80, 200, 170));

        jLabel6.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        jLabel6.setForeground(Main_Colores.C_100);
        jLabel6.setText("Descripcion:");
        panel_form.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 410, 120, -1));

        jLabel7.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        jLabel7.setForeground(Main_Colores.C_100);
        jLabel7.setText("Marca:");
        panel_form.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, -1, -1));

        jLabel9.setBackground(new java.awt.Color(0, 0, 0));
        jLabel9.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        jLabel9.setForeground(Main_Colores.C_100);
        jLabel9.setText("Memoria ram:");
        panel_form.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 160, -1, -1));

        jLabel4.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        jLabel4.setForeground(Main_Colores.C_100);
        jLabel4.setText("Conectividad:");
        panel_form.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 240, -1, -1));
        ...
        panel_form.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 80, 110, -1));
        ...
        panel_form.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 330, -1, -1));
        ...
        panel_form.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 50, 200, 20));
        ...
        panel_form.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 440, 650, 90));

        btn_buscarImange.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        btn_buscarImange.setForeground(Main_Colores.Fondo);
        btn_buscarImange.setText("Buscar");
        btn_buscarImange.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        panel_form.add(btn_buscarImange, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 270, 130, -1));
        ...
        panel_form.add(btn_registrarLP, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 550, 200, 50));
        ...
        panel_form.add(tf_marca, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 200, 30));

        tf_bateriaLP.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        tf_bateriaLP.setForeground(Main_Colores.Fondo);
        panel_form.add(tf_bateriaLP, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 360, 200, 30));

        tf_conectividadLP1.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        tf_conectividadLP1.setForeground(Main_Colores.Fondo);
        panel_form.add(tf_conectividadLP1, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 270, 200, 30));

        tf_procesador.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        tf_procesador.setForeground(Main_Colores.Fondo);
        panel_form.add(tf_procesador, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 110, 200, 30));

        tf_memoriaRam.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        tf_memoriaRam.setForeground(Main_Colores.Fondo);
        panel_form.add(tf_memoriaRam, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 190, 200, 30));
        ...
        panel_form.add(tf_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 200, 30));

        jLabel15.setFont(new java.awt.Font("Bahnschrift", 0, 18)); // NOI18N
        jLabel15.setForeground(Main_Colores.C_100);
        jLabel15.setText("Nombre:");
        panel_form.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, -1, -1));
    ...
    protected javax.swing.JButton btn_buscarImange;
